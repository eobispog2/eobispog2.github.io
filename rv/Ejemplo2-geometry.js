...
forma.vertices.push( new THREE.Vector3( 1, 0 , 1 ) );   // Push empuja elementos al arreglo, este es el elemento 0
forma.vertices.push( new THREE.Vector3( 1, 0 , -1 ) );   // Elemento 1
